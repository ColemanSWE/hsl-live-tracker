...
describe('SpeedChart processData', () => {
  test('calculates correct averages', () => {
    const processedData = SpeedChart({ vehicles: mockVehicles }).props.children[1].props.children
      .props.data;
  ...
  test('handles single entry', () => {
    ...
    const processedData = SpeedChart({ vehicles: singleVehicle }).props.children[1].props.children
      .props.data;
